...
@NgModule({
  ...
  declarations: [AppLoaderComponent, BlankComponent, FullLayoutComponent, MenuLayoutComponent],
  exports: [AppLoaderComponent, BlankComponent, FullLayoutComponent, MenuLayoutComponent],
  providers: [
    AppLoaderService,
    AuthStorageService,
    LocalStorageService,
